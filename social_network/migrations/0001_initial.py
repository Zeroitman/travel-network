# Generated by Django 2.1 on 2020-09-30 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_body', models.TextField(validators=[django.core.validators.MinLengthValidator(3)],
                ...
                ('post_country',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='social_network.Country',
                                   verbose_name='Страна поста')),
            ],
            options={
                'verbose_name': 'Пост',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='client',
        ...
        migrations.AddField(
            model_name='post',
            name='post_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='social_network.UserInfo',
